...
class Controller_pyv extends Controller_DefaultTemplate {
    ...
    public function action_crear($t = '') {        
        ...
        if ($tipo->loaded()) {                
            if (isset($_POST['submit'])) {                
                ...
                $documento->id_proceso = 4; //4 = varios;
                ...
                //$documento->titulo = $_POST['funcionario'];
                ...
                if ($documento->id) {
                    ...
                    ///creamos el fucov:
                    $fucov = ORM::factory('pyvfucov');
                    //Declaratoria Comision
                    $fucov->id_area_funcional = $_POST['areas'];
                    $fucov->id_user_comision = $_POST['funcionario'];
                    $fucov->nombre_user_comision = $_POST['nombreFuncionario'];
                    $fucov->cargo_user_comision = $_POST['cargo'];
                    $fucov->id_area_inmediato_superior = $_POST['autorizadoPor'];
                    $fucov->id_inmediato_superior = $_POST['superior'];
                    $fucov->nombre_inmediato_superior = $_POST['nombreSuperior'];
                    $fucov->cargo_inmediato_superior = $_POST['cargoSuperior'];
                    $fucov->fecha_ini_comision = substr($_POST['finicio'],4,10);                    
                    $fucov->hora_ini_comision = $_POST['hinicio'];
                    $fucov->fecha_fin_comision = substr($_POST['fconclusion'],4,10);
                    $fucov->hora_fin_comision = $_POST['hconclusion'];
                    
                    ///Actividad Programada
                    $fucov->fecha_act_1 = $_POST['factividad1'];
                    $fucov->tipo_1 = $_POST['tipo1'];
                    $fucov->lugar_1 = $_POST['lugar1'];
                    $fucov->actividad_1 = $_POST['actividad1'];
                    $fucov->resultado_1 = $_POST['resultado1'];
                    $fucov->fecha_act_2 = $_POST['factividad2'];
                    $fucov->tipo_2 = $_POST['tipo2'];
                    $fucov->lugar_2 = $_POST['lugar2'];
                    $fucov->actividad_2 = $_POST['actividad2'];
                    $fucov->resultado_2 = $_POST['resultado2'];
                    
                    ///POA - PPTO
                    $fucov->id_unidad_ejecutora = $_POST['idUnidadEjecutora'];
                    $fucov->id_autoridad = $_POST['autoridad'];
                    $fucov->nombre_autoridad = $_POST['nombreAutoridad'];
                    $fucov->cargo_autoridad = $_POST['cargoAutoridad'];
                    $fucov->id_obj_gestion = $_POST['codObjGestion'];
                    $fucov->id_obj_especifico = $_POST['codObjEsp'];
                    //$fucov->cod_actividad = $_POST[''];
                    
                    $fi = substr($_POST['finicio'], 0, 3);
                    $ff = substr($_POST['fconclusion'], 0, 3);
                    ///verificar feriados
                    if( $fi == 'Sab' || $fi == 'Dom' || $ff == 'Dom' || $ff == 'Sab')
                        $fucov->comision_fin_semana = 1;
                    else
                        $fucov->comision_fin_semana = 0;
                    //$fucov->justificacion_fin_semana = $_POST[''];                    
                    $fucov->id_user = $this->user->id;
                    $fucov->id_documento = $documento->id;
                    
                    if( $_POST['pasajeFinanciadoPor'] == 'otro')
                                $fucov->financiador_pasaje = $_POST['financiadorPasaje'];
                            
                            ///Viaticos
                            ///tablapyvliquidacion
                            $fucov->financiamiento_viatico = $_POST['viaticoFinanciadoPor'];
                            if($_POST['viaticoFinanciadoPor'] == '25' || $_POST['viaticoFinanciadoPor'] == '70')//{
                                $fucov->financiador_viatico = $_POST['financiadorViatico'];
                                //$fucov->alcance = $_POST['alcance'];}
                            if($_POST['viaticoFinanciadoPor'] == '0')
                                $fucov->just_renuncia_viatico = $_POST['justRenuncia'];
                            //$fucov->id_fuente_presupuesto = $_POST['fuentePresupuesto'];
        
                            $fucov->estado_registro = 1;
                            $fucov->etapa_proceso = 'creado';
                            $fucov->fecha_creacion = date('Y-m-d H:i:s');
                            
                    $fucov->num_dias = $_POST['dias'];
                    $fucov->viatico_dia = $_POST['viaticoDia'];
                    $fucov->categoria_funcionario = $_POST['categoria_cal'];
                    $fucov->tipo_cambio = 6.88;
                    $fucov->moneda = $_POST['moneda'];
                    
                    $fucov->save();
                    
                    if($fucov->id){
                        $pasajes = ORM::factory('pyvpasajes');///Itinerario
                        ///guardar registro en la tabla pyvpasajes
                        $pasajes->id_pyvfucov = $fucov->id;
                        $pasajes->tipo_pasaje = $_POST['tipoTransporte'];
                        $pasajes->fecha_salida = $_POST['fechaSalidaIda'];
                        $pasajes->hora_salida = $_POST['horaSalidaIda'];
                        $pasajes->fecha_retorno = $_POST['fechaArriboRet'];
                        $pasajes->hora_retorno = $_POST['horaArriboRet'];

                        ///definir ida o vuelta                        
                        $pasajes->tramo_viaje = '';                        
                        
                        $pasajes->empresa_salida = $_POST['empresaIda'];
                        $pasajes->num_boleto_salida = $_POST['boletoIda'];
                        $pasajes->costo_salida = $_POST['costoIda'];
                        $pasajes->empresa_retorno = $_POST['empresaRet'];
                        $pasajes->num_boleto_retorno = $_POST['boletoRet'];
                        $pasajes->costo_retorno = $_POST['costoRet'];
                        
                        if( $_POST['costoIda'] != 0 || $_POST['costoRet'] != 0)
                            $pasajes->etapa_proceso = 'PASAJE ASIGNADO';
                        
                        $pasajes->reservado_por = '';
                        $pasajes->estado_pasaje = 1;
                        $pasajes->justificacion = 'Ninguna';
                        $pasajes->nota_debito = 'Ninguna';
                        $pasajes->multas = 0;
                        ///procesar
                        $pasajes->costo_final = 0;
                        
                        $pasajes->id_zona = $_POST['zona'];
                        $pasajes->localidad_origen = $_POST['ciudadOrigen'];
                        $pasajes->dep_origen = $_POST['deptoOrigen'];
                        $pasajes->id_pais_origen = $_POST['paisOrigen'];
                        $pasajes->localidad_destino = $_POST['ciudadDestino'];
                        $pasajes->dep_destino = $_POST['deptoDestino'];
                        $pasajes->id_pais_destino = $_POST['paisDestino'];
                        $pasajes->save();
                        //$this->request->redirect('pyv/editar/' . $fucov->fecha_fin_comision);
                        ///$this->request->redirect('documento/editar/' . $documento->id);
                        $this->request->redirect('pyv/editar/'.$documento->id);
                        //$this->template->content = "Guardado";
                        //$this->request->redirect('pyv/editar/'.'236');                        
                    }
                }                
            }
        }
                
        ///todas las unidades funcionales pertenecientes a la entidad del usuario
        $areas=  ORM::factory('oficinas')->where('id_entidad','=',$this->user->id_entidad)->find_all();
        $areafuncional=array();
        foreach($areas as $a){ $areafuncional[$a->id]=$a->oficina; }
        
        ///la unidad ejecutora para el usuario
        $uEjec = New Model_pyvunidadfuncional();
        $ue = $uEjec->unidadejecutora($this->user->id);
        foreach ($ue as $d): $id_ue = $d['id']; $ue = $d['oficina']; endforeach;
        
        ///autoridad que autorizara el viaje
        $aComp = New Model_pyvunidadfuncional();
        $aut = $aComp->autoridadcompetente($this->user->id_oficina);
        
        ///POA
        $oGest = New Model_pyvobjetivogestion();
        $og=$oGest->codobjetivogestion($id_ue);
        
        ///Zona Viaje
        $zonas = ORM::factory('pyvzona')->where('estado','=',1)->find_all();
        $zona = array();
        foreach($zonas as $a){ $zona[$a->id]=$a->zona;}           
        
        ///fuente presupuestaria
        /*$oFte = New Model_pyvestructuraprogramatica();
        $fte = $oFte->fuente($this->user->id_oficina);
        $fuente = array();
        foreach ($fte as $p) {
            $fuente[$p->id] = $p->fuente;
        }*/
        ...
        if (isset($_POST['submit'])) 
            ...
            $var = 'nuevo';        
        $this->template->title .= ' | '. $var .' - '. $tipo->tipo;
        ...
        $this->template->content = View::factory('pyv/createfucov')
                                        ->bind('idunidadejecutora',$id_ue)
                                        ->bind('unidadejecutora', $ue)
                                        ->bind('objetivogestion',$og)
                                        ->bind('autoridadcompetente',$aut)
                                        ->bind('areafuncional', $areafuncional)
                                        ->bind('documento', $tipo)
                                        ->bind('tipo', $tipo)
                                        ->bind('user', $this->user)
                                        ->bind('zona', $zona);                            
    ...
    public function action_editar($id = '') {
        //$this->template->content = 'datos guardados'.$id;
        
        $mensajes = array();
        $documento = ORM::factory('documentos')->where('id', '=', $id)->and_where('id_user', '=', $this->user->id)->find();
        $fucov = ORM::factory('pyvfucov')->where('id_documento','=',$id)->find();
        if ($documento->loaded()) {
...
//                   $documento->fecha_creacion=  time(); //fecha y hora en formato int
            ...
            ///funcionario en comision
            $areas = ORM::factory('users')->where('id_oficina','=',$fucov->id_area_funcional)->find_all();
            $usercomision=array();
            foreach($areas as $a){ $usercomision[$a->id]=$a->nombre; }

            ///Autrizado Por
            $oAut = new Model_pyvunidadfuncional();
            $aut = $oAut->autorizadopor($fucov->id_area_funcional);
            //foreach($areas as $a){ $usercomision[$a->id]=$a->nombre; }
            /*if ($tipo->tipo == 'Circular') {
                ...
                $this->template->content = View::factory('pyv/editfucov')
                        ->bind('documento', $documento)
                        ->bind('archivos', $archivos)
                        ->bind('tipo', $tipo)
                        ->bind('superior', $superior)
                        ...
                        ->bind('fucov', $fucov)
                        ->bind('areafuncional', $areafuncional)
                        ->bind('usercomision', $usercomision)
                        ->bind('aut', $aut);
            ///}
        } else {
    ...
    public function action_detalle($id = 0) {
        ...
        if ($documento->loaded()) {
            ...
            if ($ok) {
                ...
                $fucov = ORM::factory('pyvfucov')->where('id_documento','=',$id)->find();
                //poa                
                $og = ORM::factory('pyvobjetivogestion')->where('id_obj_gestion','=',$fucov->id_obj_gestion)->find();
                $oe = ORM::factory('pyvobjetivoespecifico')->where('id_obj_especifico','=',$fucov->id_obj_especifico)->find();
                //pasajes
                $oPsj = new Model_Pyvpasajes();
                $pasajes = $oPsj->pasaje_asignado($fucov->id);
                
                $this->template->scripts = array('ckeditor/adapters/jquery.js', 'ckeditor/ckeditor.js');
                $this->template->title .= ' | ' . $documento->codigo;
                $this->template->content = View::factory('pyv/detalle')
                        ->bind('d', $documento)
                        ->bind('tipo', $tipo)
                        ->bind('archivo', $archivo)
                        ->bind('errors', $errors)
