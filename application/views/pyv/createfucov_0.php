...
function calcular(id,ctrl){
    ...
    ops = "categoriazona";
        ...
        $.ajax({
            ...
            {                   
                ...
                $("#total").val(viaticos * dias);
                ///$("#total").val($("#viaticoDia").val());
            }   
        });
        //alert('enter');   
    }
    ...
    /*var viaticos = parseFloat($('#viaticoDia').val());
    var dias = parseInt($('#dias_cal').val());
    var total = viaticos * dias;
    $('#total').val(total);
    alert('Viatico:'+var1+'dias: '+dias+' Total: '+total);*/
    //alert('ASD '+asf);
}
$(function(){    
...
$('#funcionario').change(function(){        
        ...
        if(!id) {$('#cargo').val(''); /*$('#destinatario').val('');*/}
        else{
            var ctrl = $('#cargo');
            var ops = 'cargo';
            var tipo = 'txt';
...
$("input[name=viaticoFinanciadoPor]:radio").click(function(){
    ...
    if(selection == 'mdp'){
        ...
        //$("#alcance").attr("disabled","disabled");//$("#alcance2").attr("disabled","disabled");
        }
    else{
        if(selection == 'otro'){
            ...
            //$("#alcance").removeAttr("disabled");}//$("#alcance2").removeAttr("disabled");}
        else
        {
...
$.datepicker.regional['es'] = {
      ...
      $("#factividad1,#factividad2,#factividad3").datepicker(pickerOpts,$.datepicker.regional['es']);
...
<div style="border-bottom: 1px solid #ccc; background: #F2F7FC; display: block; padding: 10px 0;   width: 150.8%;">
            <h2 align="center">Informaci&oacute;n del Documento</h2>
            <br />
            <fieldset>
...
<table width="100%" border="1px">
                ...
                <td colspan="2" style="padding-left: 5px;">
                <?php
                echo Form::label('referencia', 'Motivo del Viaje:',array('class'=>'form'));?> 
                    <textarea name="referencia" id="referencia" style="width: 500px;" class="required"></textarea>
...
<table width="100%" border="1px">
    ...
    <!--<tr>
        <td>
            <?php
                echo Form::label('sigma','Registro Beneficiario Sigma(*)',array('class'=>'form'));
            ?>
        </td>
        <td><?php
                echo Form::input('sigma','');
            ?>
        </td>
    </tr>-->
    <tr>
        ...
        <table width="100%" border="1px">
            ...
            <tr>
                ...
                <td>
                    ...
                    <option value="vehiculo">V&iacute;a Ve&iacute;culo Oficial</option>
                    </select>
                </td>
            </tr>
            <tr>
        ...
        <table width="100%" border="1px">
            ...
            <tr>
             ...
             <tr>
                ...
                <td><?php echo Form::radio('viaticoFinanciadoPor','mdp',FALSE,array('class'=>'required','id'=>'viaticoFinanciadoPor','name'=>'viaticoFinanciadoPor'));?>
                </td>
                <td colspan="2"><?php echo Form::label('viaticoFinanciadoPor','Ministerio de Desarrollo Productivo y Econom&iacute;a Plural.',array('class'=>'form'));?>                  
                </td>                
            </tr>           
            <tr>
                <td>                                        
                </td>
                <td><?php   echo Form::radio('viaticoFinanciadoPor', 'otro',array('id'=>'viaticoFinanciadoPor','name'=>'viaticoFinanciadoPor'));?>                                    
                </td>
                <td colspan="2"><?php echo Form::label('financiadorViatico','Otra Instituci&oacuten:',array('class'=>'form'));?>                
                </td>                
            </tr>            
            <tr>
                <td>                    
                ...
                <td colspan="2"><?php echo Form::label('financiadorViatico','Instituci&oacute;n:',array('class'=>'form'));?>
                    <?php echo Form::input('financiadorViatico','',array('class'=>'form','size'=>'75','id'=>'financiadorViatico','class'=>'required'));?>
                </td>
            ...
            <tr>
                ...
                <td align="right"><?php echo Form::radio('alcance','75', FALSE, array('class'=>'required','id'=>'alcance1','name'=>'alcance'));?>
                </td>
                <td>
            ...
            <tr>
                ...
                <td align="right"><?php echo Form::radio('alcance','25',FALSE,array('class'=>'required','id'=>'alcance2','name'=>'alcance'))?>
                </td>
                <td>
            ...
            <tr>
                ...
                <td><?php echo Form::radio('viaticoFinanciadoPor', 'no',array('id'=>'viaticoFinanciadoPor','name'=>'viaticoFinanciadoPor'));?>
                </td>
            ...
            <tr>
                ...
                <textarea name="justRenuncia" id="justRenuncia" style="width: 450px;" class="required"></textarea>                
                </td>                
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td colspan="2">
                    <!--<select name="fuentePresupuesto" id="fuentePresupuesto" class="required" style="width: 350px;">
                        <option value="" selected="true"></option>                    
                    </select>-->
                </td>                
            </tr>           
...
<table border="1px" >
     <!--<tr>
        <td><?php echo Form::label('pasajes','ASIGNACION DE PASAJES: ',array('class'=>'form'));?>
        </td>
        <td><?php echo Form::input('asignacionPasaje','PASAJE NO ASIGNADO',array('class'=>'form','id'=>'asignacionPasaje','disabled'=>'true','size'=>'25'))?>
        </td>
        <td><?php echo Form::label('tipoTrasnporte','TIPO TRANSPORTE: ',array('class'=>'form'));?>
        </td>
        <td><?php echo Form::input('tipoDeTransporte','',array('class'=>'form','id'=>'tipoDeTransporte','disabled'=>'true','size'=>'25'))?>                    
        </td>
        <td><?php echo Form::label('tipoPasaje','TIPO PASAJE: ',array('class'=>'form'));?>
        </td>
        <td><?php echo Form::input('tipoPasaje','',array('class'=>'form','id'=>'tipoPasaje','disabled'=>'true','size'=>'25'))?>                    
        </td>
     </tr>-->
     <tr>
        <td><?php echo Form::label('viaticos','VI&Aacute;TICO POR D&Iacute;A : ',array('class'=>'form'));?>
        </td>
        <td><?php echo Form::input('viaticoDia','0',array('class'=>'form','id'=>'viaticoDia','disabled'=>'true','size'=>'25'))?>        
        </td>
        <td><?php echo Form::input('moneda','',array('class'=>'form','id'=>'moneda','disabled'=>'true','size'=>'5'))?>
        </td>
        <td>
        </td>
        <td></td>
      ...
      <tr>
        <td><?php echo Form::label('dias','D&Iacute;AS : ',array('class'=>'form'));?>
        </td>
        <td><?php echo Form::input('dias','1',array('class'=>'form','id'=>'dias_cal','name'=>'dias_cal','disabled'=>'true','size'=>'25'))?>        
        </td>
        <td>
        </td>
        <td>
     ...
     <tr>
        <td><?php echo Form::label('total','TOTAL : ',array('class'=>'form'));?>
        </td>
        <td><?php echo Form::input('total','0',array('class'=>'form','id'=>'total','name'=>'total','disabled'=>'true','size'=>'25'))?>        
        </td>
        <td>
        </td>
        <td>
...
<br />
<input type="text" id="categoria_cal" name="categoria_cal" />

<!--<input type="text" id="dias_cal" name="dias_cal" value="1" />-->

<input type="text" id="zona_cal" name="zona_cal" />


<input type="submit" value="Crear documento" class="uibutton" name="submit" id="crear" title="Crear documento nuevo"  />
<?php //echo Form::input('destinatario','',array('id'=>'destinatario','size'=>45,'class'=>'required'));?>

</form>
<!--<input type="text" value="documento/crear/<?php echo $documento->action;?>" size="150" />-->
<!--<input type="text" id="respuesta" value="respuesta" size="150" />-->
</div>